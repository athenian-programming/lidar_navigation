...
from lidar_constants import PLOT_ALL, PLOT_CENTROID, PLOT_POINTS, MAX_AXIS_MULT
from lidar_constants import PAUSE, ITERATIONS, MIN_POINTS, THRESHOLD, ITERATIONS_DEFAULT, THRESHOLD_DEFAULT
from lidar_constants import MIN_POINTS_DEFAULT, CONTOUR_TOPIC_DEFAULT, MAX_AXIS_MULT_DEFAULT, PAUSE_DEFAULT
